...
namespace SaysanPwa.Api.Pages.ServiceSaleFactor
{
    public class PrintModel : PageModel
    {
        ...
        public PageResult<List<GetServiceSaleFactorDto>?> PageResult { get; set; } = new();
        ...
        public async Task OnGet(int FactorId)
        {
            ...
            var Result = await _mediator.Send(new GetServiceSaleFactorPrintQuery(FactorId, userFiscalYear, null, null, null, null, null));
